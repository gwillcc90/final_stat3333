...
Some questions to ask:
 - Can we find an estimation region for the true mean abortions of women over 40
...
```{r, echo = F}
abortions <- abortions[,c('state','year','abortionslt15',	
                          'abortions1517',	
                          'abortions1819',
...
First, let's look at the mean difference in abortions by age groups.
